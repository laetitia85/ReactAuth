       ...
       return (
          ...
          {this.props.carteProducts.map(item => (
            <div key={item.id} className='productElement' >
              ...
              <div className='description'>
                <b>The name of this product: </b>{item.productName}
                <p></p>
                <b>The price: </b>{item.price}
                <br></br>
                <br></br>
                <button type="submit" onClick={this.decrement.bind(this)} name={item.id} className='Beutton'>-</button>
                <br></br>
                ...
                <br></br>
                <button type="submit" id={item.id} onClick={this.increment.bind(this)}>+</button>
              </div>
        ...
        <hr></hr>
         ...
         this.props.carteProducts.reduce((a, b) => {
           ...
           ) :this.props.carteProducts.length === 1 ? this.props.carteProducts[0].priceOfQuantity : 0}
